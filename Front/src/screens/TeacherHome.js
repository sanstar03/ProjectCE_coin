  ...
  return (
    < SafeAreaView  style={styles.viewStyle}>
      ...
      <View style={styles.viewStyle6}>
        ...
        <TouchableOpacity style={styles.viewStyle5} onPress={() => forceUpdate}>
        ...
        <View style={styles.loginScreenButton}>
          <TouchableOpacity style={styles.buttonShadow}  onPress={() => navigate("AccT")}>
      ...
      <View style={styles.viewButton}>
        ...
        <TouchableOpacity style={styles.buttonShadow}  onPress={() => navigate("CreateAc")}>
          ...
          <View style={styles.MenuButton}>
        <TouchableOpacity style={styles.buttonShadow}  onPress={() => {navigate("Tran")}}>
          ...
          <View style={styles.MenuButton}>
        <TouchableOpacity style={styles.buttonShadow}  onPress={() => navigate("Codegen")}>
